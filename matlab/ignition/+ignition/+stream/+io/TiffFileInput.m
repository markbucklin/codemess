...
% 				initializeModuleEnvironment(obj); % @Module
		...
		function varargout = stepImpl(obj)
			...
			vidSegment = ignition.shared.datatype.VideoSegment(frameData, frameTime, frameInfo, frameIdx);
				...
				vidSegment = ignition.core.type.VideoFrame(frameData, frameTime, frameInfo, frameIdx);
			end
...
% 			ignition.internal.DeferredTask( @dispatchRemoteLoad, 0, obj)
			% 			numArgsOut = nargout;
...
try			
	...
	obj.DataSetName = 'dataset';
			...
			[stackInfo, fileInfo, ~] = ignition.io.tiff.initializeTiffStack(allTiffObj, parseFrameInfoFcnHandle);
			...
			obj.ReadFrameFcn = @ignition.io.tiff.readFrameFromTiffStack;
