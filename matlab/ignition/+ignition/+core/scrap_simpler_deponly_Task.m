classdef (CaseInsensitiveProperties, TruncatedProperties) ...
	...
	properties (SetAccess = protected)
		...
		OutputDependency ignition.core.Dependency %@cell %@ignition.core.Dependency
	...
	methods
		...
		function obj = Task(op, varargin)
			...
			if (nargin > 0)
				...
				% 				for k=1:op.NumOutputs
				% 					obj.OutputDependency{k} = @ignition.core.Dependency.empty;
				% 					obj.OutputRequestedFlag(k) = false;
				% 				end
			end
