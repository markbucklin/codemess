classdef TaskCache < ignition.core.object & handle
	% TaskCache - provides initialization, update, and recursion & storage of a persistent variables used by a Task
		...
		methods
			function obj = TaskCache(varargin)
				if nargin
