classdef (CaseInsensitiveProperties = true) LabelPropagator < scicadelic.SciCaDelicSystem
...
% 			regionFirstFrame = obj.RegionFirstFrame;
			...
			if inputNumFrames > idxStart
				for k = idxStart:inputNumFrames
					...
					overlyingPairMap = bsxfun(@and, (isInBoundingBox(roiA, roiB)) , (isInBoundingBox(roiB, roiA)'));
