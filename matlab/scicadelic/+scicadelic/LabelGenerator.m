classdef (CaseInsensitiveProperties = true) LabelGenerator < scicadelic.SciCaDelicSystem
	...
	% CONSTRUCTOR
	methods
		function obj = LabelGenerator(varargin)
	...
	methods (Access = protected)
		function setupImpl(obj, data)
			...
			if isempty(obj.LabelMatrix)
				labelMatrix = spalloc(regionAlloc, frameAlloc, floor(frameAlloc*regionAlloc/4));
